...
public class RisingSpiralPower : PicklerFrigilPower
{
    public override PowerType Type => PowerType.Buff;
    public override PowerStackType StackType => PowerStackType.Counter;
    
    public override string CustomPackedIconPath => "res://PicklerFrigil/images/powers/picklerfrigil-rising_spiral_power.png";
    public override string CustomBigIconPath => "res://PicklerFrigil/images/powers/big/picklerfrigil-rising_spiral_power.png";
        ...
        ICombatState combatState)
    {
        ...
        {
            CardModel c = combatState.CreateCard<RisingSpiral>(Owner.Player!);
